...
Windows started to lag after 90% of RAM usage but my [[post/Hyprland]] only use about 70% of RAM after using more windows than that of windows. 
## How I installed
...
After installing Fedora, I explored the default GNOME, tried a few extensions, tweaked some keyboard shortcuts and installed few packages. I was exploring the default fedora but then I came across my friend's [[Dotfiles]], he recently installed Arch + [[post/Hyprland]] with Omarchy script which deletes everything on your system and installs Arch linux. 
...
So I had GNOME as default on my machine, but I was curious about [[post/Hyprland]]. And to my surprise fedora uses wayland and it supports [[post/Hyprland]], so I decided to give it a try. 
